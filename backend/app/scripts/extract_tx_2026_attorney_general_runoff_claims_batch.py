"""
Extract claims in batch for Texas 2026 Attorney General runoff statements.
...
TARGET_STATE = 'TX'
TARGET_OFFICE = 'Attorney General'
TARGET_ELECTION_CYCLE = 2026
TARGET_STAGES: tuple[RaceStage, ...] = (RaceStage.primary_runoff,)
...
def main() -> None:
    ...
    try:
        ...
        print(
            'Texas 2026 Attorney General runoff extraction complete. '
