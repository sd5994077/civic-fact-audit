"""
Generate a Texas 2026 publish queue diagnostics report.

This report shows which claims can be published now and which publish-gate
...
def main() -> None:
    ...
    try:
        ...
        print(f'Texas 2026 publish queue items: {len(rows)}')
