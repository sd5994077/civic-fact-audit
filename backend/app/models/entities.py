...
class Claim(TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        Index('ix_claims_is_published_published_at', 'is_published', 'published_at'),
        Index(
            'ix_claims_fulltext',
...
class NotificationEvent(TimestampMixin, Base):
    __tablename__ = 'reviewer_notifications'
    ...
    reviewer_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey('reviewer_users.id', ondelete='CASCADE'), nullable=False
    )
